...
export const DeleteTaskTagDialog = ({ tag, open: controlledOpen, onOpenChange: onControlledOpenChange, isPending = false, onConfirm }: IDeleteTaskTagDialogProps) => {
    ...
    <AlertDialog open={open} onOpenChange={setOpen}>
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>Are you sure you want to delete "{tag.name}"? This action cannot be undone.</AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
